...
% opts.batch_size
function rbm = rbmtrain_seq_rectifierunits(rbm,X,opts,flag_seq)
...
%     end
    ...
    for l = 1:1:numbatches
        ...
        % using the rectifier linear units
        unit_input = v0 * rbm.W' + repmat(rbm.bh',num_images_per_batch,1);
        pos_Hj_states = max(0,unit_input);
