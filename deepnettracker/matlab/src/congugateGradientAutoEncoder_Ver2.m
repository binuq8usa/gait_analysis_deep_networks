function [f,df] = congugateGradientAutoEncoder_Ver2(VV,Dim,XX)
...
% Binomial KL divergence or cross-entropy cost function
% Generally used for stacked autoassociator networks
